...
// mingcute icon: key-4-line · @iconify-json/mingcute v1.2.8
import { Svg, Circle as SvgCircle, Path as SvgPath } from 'react-native-svg';
import type { IconProps } from '../icon-props';
import { useIconColor } from '../resolve-icon-color';

export function Key4Line({ size = 24, color: colorProp, style, accessibilityLabel, testID, ...props }: IconProps) {
