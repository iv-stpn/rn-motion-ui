...
// mingcute icon: loading-2-fill · @iconify-json/mingcute v1.2.8
import { Svg, G as SvgG, Path as SvgPath } from 'react-native-svg';
import type { IconProps } from '../icon-props';
import { useIconColor } from '../resolve-icon-color';

export function Loading2Fill({ size = 24, color: colorProp, style, accessibilityLabel, testID, ...props }: IconProps) {
