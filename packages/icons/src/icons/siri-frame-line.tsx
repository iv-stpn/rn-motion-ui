...
// mingcute icon: siri-frame-line · @iconify-json/mingcute v1.2.8
import { Svg, Path as SvgPath, Rect as SvgRect } from 'react-native-svg';
import type { IconProps } from '../icon-props';
import { useIconColor } from '../resolve-icon-color';

export function SiriFrameLine({ size = 24, color: colorProp, style, accessibilityLabel, testID, ...props }: IconProps) {
