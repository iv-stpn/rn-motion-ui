...
// mingcute icon: swimming-line · @iconify-json/mingcute v1.2.8
import { Svg, Path as SvgPath } from 'react-native-svg';
import { useThemeColor } from 'rn-motion-ui/theme/use-theme-color';
import type { IconProps } from '../icon-props';

export function SwimmingLine({ size = 24, color: colorProp, style, accessibilityLabel, testID }: IconProps) {
