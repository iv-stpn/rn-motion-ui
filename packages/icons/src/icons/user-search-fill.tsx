...
// mingcute icon: user-search-fill · @iconify-json/mingcute v1.2.8
import { Svg, Path as SvgPath } from 'react-native-svg';
import type { IconProps } from '../icon-props';
import { useIconColor } from '../resolve-icon-color';

export function UserSearchFill({ size = 24, color: colorProp, style, accessibilityLabel, testID, ...props }: IconProps) {
  ...
  return (
    ...
    >
      ...
      <SvgPath
        fill={color}
        fillRule="evenodd"
        d="M17.5 14a3.5 3.5 0 1 0 1.665 6.58l.835.834A1 1 0 0 0 21.414 20l-.835-.835A3.5 3.5 0 0 0 17.5 14M16 17.5a1.5 1.5 0 1 1 3 0a1.5 1.5 0 0 1-3 0"
        clipRule="evenodd"
      />
    </Svg>
  );
