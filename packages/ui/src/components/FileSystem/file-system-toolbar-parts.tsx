...
export type StatusBarProps = { count: number; isSearching: boolean; selectedName?: string };
...
export function FileSystemStatusBar({ count, isSearching, selectedName }: StatusBarProps) {
