...
function FileSystemGroupGhost({ index, items }: FileSystemGroupGhostProps) {
  ...
  return (
    <View className="hairline flex-row items-center gap-1.5 self-start rounded-md border-border bg-surface-4 px-2 py-1.5">
...
function FileSystemDropHint({ containerRef }: FileSystemDropHintProps) {
  ...
  return (
    ...
    >
      <View className="hairline flex-row items-center gap-1.5 self-start rounded-md border-border bg-surface-4 px-1.5 py-0.5">
