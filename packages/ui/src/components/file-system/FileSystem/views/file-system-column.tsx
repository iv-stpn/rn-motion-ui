  ...
  return (
    <View
      className={cn(
        ...
        external ? 'hairline border-foreground/20 border-dashed bg-foreground/[0.03]' : 'hairline rounded-lg border-info',
      )}
    />
  );
}
...
function FileSystemColumnImpl({
  ...
  return (
    <Pressable
      ref={containerRef}
      className="hairline-r shrink-0 select-none border-border"
