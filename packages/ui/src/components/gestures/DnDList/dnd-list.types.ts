// Public types for the DnD list component.
//
// Kept in its own module so the pure reorder logic in `dnd-reorder.ts` can import
...
/**
 * Props for the `<DnDList>` component.
 *
 * ```tsx
 * <DnDList
 *   items={todos}
...
export type DnDListProps<T> = {
   ...
   * @default 'application/x-dnd-item'
   */
  mimeType?: string;
