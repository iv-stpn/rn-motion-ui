...
function Chip({ label, onDragEnd }: ChipProps) {
  return (
    ...
    >
      <View className="hairline rounded-md border-border bg-surface-2 px-3 py-1.5">
...
function Slot({ label }: SlotProps) {
  return (
    <Dragzone
      className="hairline min-w-[130px] rounded-lg border-border border-dashed p-3"
...
function Board({ groups, isolate, label, onDragEnd, onDrop }: BoardProps) {
  return (
    <DragManager
      className="hairline gap-2 rounded-xl border-border p-3"
      groups={groups}
      isolate={isolate}
...
function LifecycleDemo() {
  ...
  return (
    ...
    >
      <DragManager className="hairline flex-row gap-3 rounded-xl border-border p-3">
