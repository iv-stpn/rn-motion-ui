...
function Demo({ once, y, amount }: DemoProps) {
  ...
  return (
    <View
      className="hairline w-[360px] overflow-hidden rounded-2xl border-border"
      ...
      <ScrollView contentContainerStyle={{ padding: 24, gap: 48 }} onScroll={onScroll} scrollEventThrottle={16}>
        ...
        {CARDS.map((label) => (
          <ScrollReveal
            ...
            y={y}
          >
            <View className="hairline rounded-xl border-border bg-surface-3 px-4 py-12">
