...
function ScrollTopButton({ onPress }: ScrollTopButtonProps) {
  ...
  return (
    <Pressable
      ...
      testID="scroll-top"
      onPress={handlePress}
      className="hairline absolute right-3 bottom-3 h-9 w-9 items-center justify-center rounded-full border-[#e5e5e5] bg-[#fafafa]"
    >
...
function Demo() {
  return (
    <View className="hairline h-[280px] w-[360px] overflow-hidden rounded-2xl border-[#e5e5e5]">
