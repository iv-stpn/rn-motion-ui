...
const NEUTRAL_HUE = 270; // the hue of the neutral axis, in degrees
...
const LIGHT_OKLCH: Record<ThemeToken, Oklch> = {
  ...
  secondary: [0.92, 0, 0],
  'secondary-foreground': [0.32, 0.004, NEUTRAL_HUE],
  accent: [0.91, 0, 0],
  'accent-foreground': [0.22, 0.004, NEUTRAL_HUE],
...
const DARK_OKLCH: Record<ThemeToken, Oklch> = {
  ...
  'secondary-foreground': [0.94, 0.004, NEUTRAL_HUE],
  accent: [0.31, 0.004, NEUTRAL_HUE],
  'accent-foreground': [0.95, 0.004, NEUTRAL_HUE],
  ...
  black: [0, 0, 0],
  background: [0, 0, 0],
  glass: [0.26, 0.004, NEUTRAL_HUE, 0.55],
  'glass-rim': [1, 0, 0, 0.14],
};
